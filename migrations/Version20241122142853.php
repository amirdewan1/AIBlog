 ...
 */
final class Version20241122142853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD image_path VARCHAR(255) DEFAULT NULL, CHANGE genre_id genre_id INT NOT NULL, CHANGE description description LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP image_path, CHANGE genre_id genre_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL');
